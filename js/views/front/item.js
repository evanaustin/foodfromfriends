                ...
                App.Ajax.post('order/modify-quantity', $.param(data), 
                    function(response) {
                        ...
                        $(Slidebar.events).on('opened', function () {
                            ...
                            $('.cart-item[data-item-id="' + formdata['item-id'] + '"]').find('select option').attr('selected', false);
                            $('.cart-item[data-item-id="' + formdata['item-id'] + '"]').find('select option[value=' + response.item.quantity + ']').attr('selected', 'selected');

                            // Update item subtotal
                            $('.cart-item[data-item-id="' + formdata['item-id'] + '"]').find('.item-price').text(response.item.subtotal);
