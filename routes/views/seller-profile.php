                                        ...
                                        <div class="col-md-4">
                                            <div class="item card animated zoomIn">
                                                ...
                                                <div class="card-body d-flex flex-column">
                                                    ...
                                                    <?php if ($Item->is_available && ($Item->quantity || ($wholesale_relationship && $Item->wholesale_quantity))): ?>
                                                            ...
                                                            <fable id="in-stock">  
                                                                <cell>
                                                                    ...
                                                                    <select name="quantity" class="custom-select" data-parsley-trigger="change" required>
                                                                        ...
                                                                        <?php for ($i = 1; $i <= ($wholesale_relationship ? $Item->wholesale_quantity : $Item->quantity); $i++): ?>
