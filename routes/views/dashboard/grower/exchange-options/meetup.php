            ...
            <div class="col-md-6">
                <form id="save-meetup">
                    ...
                    <div id="meetup-details" <?php if (!$details['is_offered']) { echo 'style="display:none;"'; } ?>>
                        ...
                        <div class="form-group">
                            <input type="text" name="address-line-1" class="form-control" placeholder="Street address" value="<?php if (!empty($details['address_line_1'])) { echo $details['address_line_1']; } ?>" data-parsley-trigger="change" <?= (!$details['is_offered']) ? 'disabled' : 'required'; ?>>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" name="city" class="form-control" placeholder="City" value="<?php if (!empty($details['city'])) { echo $details['city']; } ?>" data-parsley-trigger="change" <?= (!$details['is_offered']) ? 'disabled' : 'required'; ?>>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="text" name="zipcode" class="form-control" placeholder="Zip code" value="<?php if (!empty($details['zipcode'])) { echo $details['zipcode']; } ?>" data-parsley-type="digits" data-parsley-length="[5,5]" data-parsley-length-message="This value should be exactly 5 digits long" data-parsley-trigger="change" <?= (!$details['is_offered']) ? 'disabled' : 'required'; ?>>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="time" class="form-control" rows="4" placeholder="When should people meet you here?" <?= (!$details['is_offered']) ? 'disabled' : 'required'; ?>><?php if (!empty($details['time'])) { echo $details['time']; } ?></textarea>
                        </div>
                    </div>
                </form>
            </div>
