                        ...
                        <div class="col-md-8">
                            ...
                            <div id="existing-operation" <?php if ($User->GrowerOperation->type != 'none') { echo 'style="display:none;"'; } ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="text" name="operation-slug" class="form-control" placeholder="The operation's referral key" data-parsley-trigger="submit" <?php if ($User->GrowerOperation->type != 'none') { echo 'disabled'; } ?>>
                                        </div>

                                        <div class="col-md-6">
                                            <input type="text" name="referral-code" class="form-control" placeholder="Your personal referral key" data-parsley-trigger="submit" <?php if ($User->GrowerOperation->type != 'none') { echo 'disabled'; } ?>>
                                        </div>
                                    </div>
