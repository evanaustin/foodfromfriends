            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Seller name" value="<?php if (!empty($User->GrowerOperation->name)) echo $User->GrowerOperation->name ?>"  data-parsley-trigger="submit" required>
                    </div>    
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" name="state" class="form-control" placeholder="State" value="<?php if (!empty($User->GrowerOperation->state)) echo $User->GrowerOperation->state ?>" data-parsley-pattern="^[a-zA-Z]{2}$" data-parsley-length="[2,2]" data-parsley-length-message="This abbreviation should be exactly 2 characters long" data-parsley-trigger="change" required>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    <div id="operation-image">
                        <div class="form-group">
                            ...
                            <a href="" class="remove-image action float-right" <?php if (empty($User->GrowerOperation->filename)) echo 'style="display: none;"' ?> data-toggle="tooltip" data-placement="left" title="Remove profile photo"><i class="fa fa-trash"></i></a>
