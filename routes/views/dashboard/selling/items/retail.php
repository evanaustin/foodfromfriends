        ...
        <div class="row">
            <div class="col-sm-12 col-md-6">
                <div class="page-title">
                    Your retail items
                    &nbsp;
                    <a href="<?= PUBLIC_ROOT ?>dashboard/selling/items/wholesale" class="badge badge-secondary">
                        Switch to wholesale
                ...
                <div class="page-description text-muted small">
                    These are all of your retail items.
                ...
                <div class="controls">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a id="copy-to-wholesale" class="dropdown-item action" href="">
                                <i class="fa fa-clone"></i> Copy to wholesale
                            </a>
                                            ...
                                            <fable>
                                                <cell>
                                                    <div class="user-block">
                                                        <div class="user-photo" style="background-image: url('<?= (isset($items[$key]->Image->id) ? 'https://s3.amazonaws.com/foodfromfriends/' . ENV . "/item-images/{$items[$key]->Image->filename}.{$items[$key]->Image->ext}" : PUBLIC_ROOT . 'media/placeholders/default-thumbnail.jpg') ?>');"></div>
                                                        ...
                                                        <div class="user-content">
                                                            <h5 class="bold muted margin-btm-25em">
                                                                ...
                                                                <a href="<?= PUBLIC_ROOT . $User->GrowerOperation->link . "/" . $items[$key]->link ?>" data-toggle="tooltip" data-title="View public item" data-placement="right">
                                                        ...
                                                        <div class="bubble">
                                                            ...
                                                            <fable>
                                                                ...
                                                                <?php if (!empty($Item->Image->id) && $Item->Image->id != $items[$key]->Image->id): ?>
                                                                    ...
                                                                    <cell class="image align-center justify-center">
