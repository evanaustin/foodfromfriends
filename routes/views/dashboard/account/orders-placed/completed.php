            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="page-title">
                        Completed orders placed
                    </div>

                    <div class="page-description text-muted small">
                        This is a collection of all your fulfilled orders placed, sorted by most recent.
                    </div>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    foreach($completed as $order) {
                        ...
                        <tr class="table-light">
                            ...
                            <td>
                                <a href="<?php echo PUBLIC_ROOT . $Routing->template . '/account/orders-placed/completed/view?id=' . $order['id']; ?>">View</a>
                            </td>
                        </tr>
