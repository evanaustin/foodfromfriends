    ...
    <div class="container animated fadeIn">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="page-title">
                        Conversation with <?= $Customer->first_name; ?>
                    </div>
                                ...
                                <fable class="message left-message">
                                    <cell class="justify-center flexcenter flexgrow-0 margin-right-1em">
                                        <a href="<?= PUBLIC_ROOT . $Grower->link; ?>">
                                            <div class="user-photo no-margin d-none d-md-block" style="background-image: url('<?= (!empty($Customer->filename) ? 'https://s3.amazonaws.com/foodfromfriends/' . ENV . '/profile-photos/' . $Customer->filename . '.' . $Customer->ext . '?' . time() : PUBLIC_ROOT . 'media/placeholders/user-thumbnail.jpg'); ?>');"></div>
                                        </a>
                                    </cell>
        ...
        <section id="new-message">
            <form id="send-message">
                <input type="hidden" name="filename" value="<?= $Grower->filename;?>">
                <input type="hidden" name="fileext" value="<?= $Grower->ext;?>">

                <input type="hidden" name="user-id" value="<?= $Customer->id;?>">
