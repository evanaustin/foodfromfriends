        ...
        <form id="edit-profile">
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <a href="" class="remove-image action float-right" <?php if (empty($User->BuyerAccount->Image->filename)) echo 'style="display: none;"' ?> data-toggle="tooltip" data-placement="left" title="Remove profile photo"><i class="fa fa-trash"></i></a>
