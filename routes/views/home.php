                ...
                <div class="col-8 col-lg-6 d-flex flexjustifycenter flexcolumn lg-no-padding">
                    ...
                    <div class="row d-md-flex">
                        ...
                        <div class="col-12 col-lg-6 col-xl-3">
                            <a href="<?= PUBLIC_ROOT . 'dashboard/selling/settings/profile'; ?>" class="btn btn-dark btn-block btn-lg start-selling">Start selling</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-6 col-xl-5">
                    <div id="practice">
                        ...
                        <div class="row d-sm-flex flexjustifycenter">
                            ...
                            <div class="col-12 col-sm-6 col-md-12 col-lg-5">
                                <a href="<?= PUBLIC_ROOT . 'dashboard/selling/settings/profile'; ?>" class="btn btn-dark btn-block btn-lg start-selling">Sell local</a>
                            </div>
                        </div>
                    </div>
                </div>
